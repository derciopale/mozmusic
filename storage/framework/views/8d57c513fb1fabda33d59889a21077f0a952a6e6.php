...
<form class="navbar-form navbar-left" role="search" action="<?php echo url('/pesquisar'); ?>" method="post" style="margin-left: 25%;margin-bottom: 3%;">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up">
              <div class="member-img">
                <img src="<?php echo e(URL::to('/')); ?>/images/<?php echo e($row->foto); ?>" class="img-fluid" alt="">
                
              </div>
              <div class="member-info">
              <h4><?php echo e($row->artista); ?></h4> 
              <span><?php echo e($row->titulo); ?></span>
               
                
                <span> 
                <audio controls style="width: 230px;  header:100px;">
  		          <source src="<?php echo e(URL::to('/')); ?>/audios/<?php echo e($row->audio); ?>" type="audio/mpeg" >
                </audio>
                </span>
                <a href="<?php echo e(route('musica.show', $row->id)); ?>" class="btn btn-default" >Ver Mais</a>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row content" data-aos="fade-up">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            <p>
            O site MusicaMoz é um projeto mocambicano de músicas online que tem como objetivo ajudar artistas e gravadoras no início de carreira a conseguir uma receita maior com a comercialização de suas músicas. 
...
<?php echo $__env->make('musica.parent', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\final\Laravel-5.8-Crud-Tutorial-master (1)\Tutorial\resources\views/principal.blade.php ENDPATH**/ ?>